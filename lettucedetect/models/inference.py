...
class SentenceDetector(BaseDetector):
    ...
    def _predict(self, context: str, answer: str):
        """Predict hallucination tokens or spans from the provided context and answer.
        ...
        input_ids, attention_mask, offset_mapping, sentence_boundaries, sentence_offset_mappings = (
    ...
    def predict_prompt(self, prompt: str, answer: str, output_format: str = "sentences") -> list:
        """Predict hallucination tokens or spans from the provided prompt and answer.

        :param prompt: The prompt string.
        :param answer: The answer string.
        :param output_format: "sentences",
        """
...
class HallucinationDetector:
    ...
    def predict_prompt(self, prompt: str, answer: str, output_format="tokens") -> list:
        """Predict hallucination tokens or spans from the provided prompt and answer.
